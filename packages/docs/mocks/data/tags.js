...
const customerTags = http.get(`https://mock.localhost/api/customers/NMWYhbGorj/tags`, async () => {
...
const organizationTags = http.get(`https://mock.localhost/api/tags`, async () => {
  return HttpResponse.json(
    {
      data: mockedTags,
