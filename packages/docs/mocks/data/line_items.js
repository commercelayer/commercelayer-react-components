...
const restPatch = http.patch(`https://mock.localhost/api/line_items/:id`, async (req, res, ctx) => {
...
const restPost = http.post(`https://mock.localhost/api/line_items`, async (req, res, ctx) => {
  return await new Promise((resolve) => {
    setTimeout(() => {
      resolve(
        res(
