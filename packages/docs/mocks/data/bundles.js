            ...
            relationships: {
              market: {
                links: {
                  ...
                  related: "https://mock.localhost/api/bundles/PljQzimxgB/market",
                },
              },
              sku_list: {
                links: {
                  self: "https://mock.localhost/api/bundles/PljQzimxgB/relationships/sku_list",
                  related: "https://mock.localhost/api/bundles/PljQzimxgB/sku_list",
                },
              ...
              attachments: {
                links: {
                  ...
                  related: "https://mock.localhost/api/bundles/PljQzimxgB/attachments",
                },
              },
              events: {
                links: {
                  self: "https://mock.localhost/api/bundles/PljQzimxgB/relationships/events",
                  related: "https://mock.localhost/api/bundles/PljQzimxgB/events",
                },
              },
              tags: {
                links: {
            ...
            relationships: {
              customer: {
                links: {
                  ...
                  related: "https://mock.localhost/api/sku_lists/myPrZIqano/customer",
                },
              },
              skus: {
                links: {
                  self: "https://mock.localhost/api/sku_lists/myPrZIqano/relationships/skus",
                  related: "https://mock.localhost/api/sku_lists/myPrZIqano/skus",
                },
              },
              sku_list_items: {
                links: {
                  self: "https://mock.localhost/api/sku_lists/myPrZIqano/relationships/sku_list_items",
                  related: "https://mock.localhost/api/sku_lists/myPrZIqano/sku_list_items",
                },
                data: [
              ...
              bundles: {
                links: {
                  ...
                  related: "https://mock.localhost/api/sku_lists/myPrZIqano/bundles",
                },
              },
              attachments: {
                links: {
                  self: "https://mock.localhost/api/sku_lists/myPrZIqano/relationships/attachments",
                  related: "https://mock.localhost/api/sku_lists/myPrZIqano/attachments",
                },
              },
            },
            meta: { mode: "test", organization_id: "WXlEOFrjnr" },
            ...
            relationships: {
              sku_list: {
                links: {
                  ...
                  related: "https://mock.localhost/api/sku_list_items/LWKOPINkWM/sku_list",
                },
              },
              sku: {
                links: {
                  self: "https://mock.localhost/api/sku_list_items/LWKOPINkWM/relationships/sku",
                  related: "https://mock.localhost/api/sku_list_items/LWKOPINkWM/sku",
                },
            ...
            relationships: {
              sku_list: {
                links: {
                  ...
                  related: "https://mock.localhost/api/sku_list_items/vWbjGINmWn/sku_list",
                },
              },
              sku: {
                links: {
                  self: "https://mock.localhost/api/sku_list_items/vWbjGINmWn/relationships/sku",
                  related: "https://mock.localhost/api/sku_list_items/vWbjGINmWn/sku",
                },
            ...
            relationships: {
              shipping_category: {
                links: {
                  ...
                  related: "https://mock.localhost/api/skus/EWzPQSpRzn/shipping_category",
                },
              },
              prices: {
                links: {
              ...
              stock_items: {
                links: {
                  ...
                  related: "https://mock.localhost/api/skus/EWzPQSpRzn/stock_items",
                },
              },
              delivery_lead_times: {
                links: {
                  self: "https://mock.localhost/api/skus/EWzPQSpRzn/relationships/delivery_lead_times",
                  related: "https://mock.localhost/api/skus/EWzPQSpRzn/delivery_lead_times",
                },
              },
              sku_options: {
                links: {
                  self: "https://mock.localhost/api/skus/EWzPQSpRzn/relationships/sku_options",
                  related: "https://mock.localhost/api/skus/EWzPQSpRzn/sku_options",
                },
              },
              attachments: {
                links: {
                  self: "https://mock.localhost/api/skus/EWzPQSpRzn/relationships/attachments",
                  related: "https://mock.localhost/api/skus/EWzPQSpRzn/attachments",
                },
              },
              events: {
                links: {
            ...
            relationships: {
              shipping_category: {
                links: {
                  ...
                  related: "https://mock.localhost/api/skus/MBrxeSaGpZ/shipping_category",
                },
              },
              prices: {
                links: {
              ...
              stock_items: {
                links: {
                  ...
                  related: "https://mock.localhost/api/skus/MBrxeSaGpZ/stock_items",
                },
              },
              delivery_lead_times: {
                links: {
                  self: "https://mock.localhost/api/skus/MBrxeSaGpZ/relationships/delivery_lead_times",
                  related: "https://mock.localhost/api/skus/MBrxeSaGpZ/delivery_lead_times",
                },
              },
              sku_options: {
                links: {
                  self: "https://mock.localhost/api/skus/MBrxeSaGpZ/relationships/sku_options",
                  related: "https://mock.localhost/api/skus/MBrxeSaGpZ/sku_options",
                },
              },
              attachments: {
                links: {
                  self: "https://mock.localhost/api/skus/MBrxeSaGpZ/relationships/attachments",
                  related: "https://mock.localhost/api/skus/MBrxeSaGpZ/attachments",
                },
              },
              events: {
                links: {
