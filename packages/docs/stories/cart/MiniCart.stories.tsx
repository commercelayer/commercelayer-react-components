...
export const Basic: StoryFn = (arg) => {
  return (
    <OrderContainer>
      ...
      />
      <CartLink label="Open mini cart" type="mini" className="underline hover:text-blue-500" />
    </OrderContainer>
  )
}
...
export const WithCartIcon: StoryFn = () => (
  <OrderContainer>
    ...
    <CartLink label={<MyCartIcon />} type="mini" className="underline hover:text-blue-500" />
  </OrderContainer>
)
