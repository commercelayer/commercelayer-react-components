  ...
  return (
    <CommerceLayer accessToken="my-access-token" endpoint="https://demo-store.commercelayer.io">
      <OrderStorage persistKey="cl-examples-skus-orderId">
        <OrderContainer>
          <SkusContainer skus={["CROPTOPWFFFFFF000000XSXX", "POLOMXXX000000FFFFFFLXXX"]}>
            <Skus>
              <div className="flex gap-4 mb-8 pb-8 border-b items-start">
                <SkuField attribute="image_url" tagElement="img" width={100} />
                <div>
                  <SkuField attribute="name" tagElement="h1" className="block font-bold" />
                  <SkuField attribute="description" tagElement="p" className="mb-2" />
          ...
          {/* cart */}
          <div id="cart-recap" className="p-8 border rounded bg-gray-100 max-w-md">
            <LineItemsContainer>
