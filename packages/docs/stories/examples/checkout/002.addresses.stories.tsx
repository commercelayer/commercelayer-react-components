                ...
                <BillingAddressForm key={billingAddress?.id}>
                  <fieldset className="flex gap-4 w-full mb-4">
                    <div className="flex-1">
                      <label htmlFor="billing_address_first_name">First name</label>
                      <AddressInput
                      ...
                      />
                      <Errors resource="billing_address" field="billing_address_first_name" />
                    </div>

                    <div className="flex-1">
                      <label htmlFor="billing_address_last_name">Last name</label>
                      <AddressInput
                      ...
                      />
                      <Errors resource="billing_address" field="billing_address_last_name" />
                    </div>
                  </fieldset>
                  ...
                  <div className="mb-4">
                    ...
                    />
                    <Errors resource="billing_address" field="billing_address_line_1" />
                  </div>
                  ...
                  <div className="mb-4">
                    ...
                    />
                    <Errors resource="billing_address" field="billing_address_line_2" />
                  </div>
                  ...
                  <fieldset className="flex gap-4 w-full mb-4">
                    <div className="flex-1">
                      ...
                      />
                      <Errors resource="billing_address" field="billing_address_city" />
                    </div>

                    <div className="flex-1">
                      <label htmlFor="billing_address_country_code">Country</label>
                      ...
                      />
                      <Errors resource="billing_address" field="billing_address_country_code" />
                    </div>
                  </fieldset>
                  ...
                  <fieldset className="flex gap-4 w-full mb-4">
                    <div className="flex-1">
                      ...
                      />
                      <Errors resource="billing_address" field="billing_address_state_code" />
                    </div>
                    ...
                    <div className="flex-1">
                      ...
                      />
                      <Errors resource="billing_address" field="billing_address_zip_code" />
                    </div>
                  </fieldset>
                  ...
                  <div className="mb-4">
                    ...
                    />
                    <Errors resource="billing_address" field="billing_address_phone" />
                  </div>
                </BillingAddressForm>
    ...
    <CommerceLayer accessToken="my-access-token">
      <OrderStorage persistKey={persistKey}>
        <OrderContainer fetchOrder={setOrder}>
          <section title="Checkout Address" className="max-w-xl">
            <CustomerContainer isGuest>
              <AddressesContainer shipToDifferentAddress={shipToDifferentAddress} invertAddresses>
                <div className="mb-4">
                  <label htmlFor="customer_email">Customer email</label>
                  <CustomerInput
                    id="customer_email"
                ...
                <ShippingAddressForm key={shippingAddress?.id}>
                  <fieldset className="flex gap-4 w-full mb-4">
                    <div className="flex-1">
                      <label htmlFor="shipping_address_first_name">First name</label>
                      <AddressInput
                      ...
                      />
                      <Errors resource="shipping_address" field="shipping_address_first_name" />
                    </div>

                    <div className="flex-1">
                      <label htmlFor="shipping_address_last_name">Last name</label>
                      <AddressInput
                      ...
                      />
                      <Errors resource="shipping_address" field="shipping_address_last_name" />
                    </div>
                  </fieldset>
                  ...
                  <div className="mb-4">
                    ...
                    />
                    <Errors resource="shipping_address" field="shipping_address_line_1" />
                  </div>
                  ...
                  <div className="mb-4">
                    ...
                    />
                    <Errors resource="shipping_address" field="shipping_address_line_2" />
                  </div>
                  ...
                  <fieldset className="flex gap-4 w-full mb-4">
                    <div className="flex-1">
                      ...
                      />
                      <Errors resource="shipping_address" field="shipping_address_city" />
                    </div>

                    <div className="flex-1">
                      <label htmlFor="shipping_address_country_code">Country</label>
                      <AddressCountrySelector
                      ...
                      />
                      <Errors resource="shipping_address" field="shipping_address_country_code" />
                    </div>
                  </fieldset>
                  ...
                  <fieldset className="flex gap-4 w-full mb-4">
                    <div className="flex-1">
                      ...
                      />
                      <Errors resource="shipping_address" field="shipping_address_state_code" />
                    </div>

                    <div className="flex-1">
                      <label htmlFor="shipping_address_zip_code">Zip Code</label>
                      <AddressInput
                      ...
                      />
                      <Errors resource="shipping_address" field="shipping_address_zip_code" />
                    </div>
                  </fieldset>
                  ...
                  <div className="mb-4">
                    ...
                    />
                    <Errors resource="shipping_address" field="shipping_address_phone" />
                  </div>
                </ShippingAddressForm>
                <fieldset className="flex gap-4 w-full mb-4">
                  <div className="flex-1">
              ...
              <AddressesContainer shipToDifferentAddress={false}>
                <BillingAddressForm
                  ...
                  customFieldMessageError={(props) => {
                    ...
                    if (props.field === "billing_address_first_name" && !regex.test(props.value)) {
                    ...
                    if (props.field === "billing_address_country_code") {
                      ...
                      if (["US", "CN", "JP", "AU", "CA"].includes(props.value)) {
                        return [
                          {
                  ...
                  <fieldset className="flex gap-4 w-full mb-4">
                    <div className="flex-1">
                      ...
                      <AddressInput
                        ...
                        required={false}
                      />
                      <Errors resource="billing_address" field="billing_address_metadata_phone" />
                    </div>
                  </fieldset>
                  <fieldset className="flex gap-4 w-full mb-4">
                    <div className="flex-1">
