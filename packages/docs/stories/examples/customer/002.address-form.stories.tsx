...
export const SampleAddressForm: StoryFn<{ address: PartialAddress }> = (args) => {
    ...
    <CommerceLayer accessToken="customer-access-token">
      <CustomerContainer>
        <AddressesContainer>
          ...
          >
            <div className="mb-4">
              <label htmlFor="billing_address_first_name" className={labelClassNames}>
                First name
              </label>
              <AddressInput
            ...
            <div className="mb-4">
              <label htmlFor="billing_address_last_name" className={labelClassNames}>
                Last name
              </label>
              <AddressInput
            ...
            <div className="mb-4">
              <label htmlFor="billing_address_line_1" className={labelClassNames}>
                Address
              </label>
              <AddressInput
            ...
            <div className="mb-4">
              <label htmlFor="billing_address_country_code" className={labelClassNames}>
                Country
              </label>
            ...
            <div className="mb-4">
              <label htmlFor="billing_address_state_code" className={labelClassNames}>
                State
              </label>
            ...
            <div className="mb-4">
              <label htmlFor="billing_address_zip_code" className={labelClassNames}>
                Zip code
              </label>
              <AddressInput
            ...
            <div className="mb-5">
              <label htmlFor="billing_address_phone" className={labelClassNames}>
                Phone
              </label>
              <AddressInput
