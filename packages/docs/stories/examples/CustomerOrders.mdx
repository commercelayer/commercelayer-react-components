...
import * as Stories from './CustomerOrders.stories.tsx'
...
<br/><br/>
In the following example you can notice that the `<OrderListRow field='number'>` cell uses a custom children render, while content of other cells is rendered with the default values.
</span>
