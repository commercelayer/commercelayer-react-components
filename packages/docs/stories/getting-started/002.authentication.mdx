...
If you are new to Commerce Layer, we suggest you to read the [Overview of Commerce Layer's OAuth 2.0](hhttps://docs.commercelayer.io/core/applications) guide.
</span>
