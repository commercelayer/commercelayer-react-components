...
const setup: Meta<typeof AddressField> = {
  ...
  argTypes: {
    name: {
      control: "select",
      options: ["first_name", "last_name", "full_name", "full_address", "email", "phone", "line_1"],
    ...
    label: {
      control: "text",
      description: "Label to be displayed in case of `field` is set to either `edit` or `delete`.",
    },
  },
}
