...
const Instructions = (): JSX.Element => (
  <div className="mb-4">
    ...
    <span title="How to use" type="warning">
      Fill the table of values below with a valid <Code>clientId</Code>, <Code>scope</Code> and{" "}
      <Code>returnUrl</Code> from your organization to see the link in action. <br />
      <br />
      As return url you can use our hosted mfe-my-account: <br />
      <Code>https://&lt;organization-slug&gt;.commercelayer.app/my-account</Code>
    </span>
  </div>
)
