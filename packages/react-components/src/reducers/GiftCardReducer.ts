...
import type { createOrder as makeOrder, getOrderContext } from "#reducers/OrderReducer"
...
const giftCardReducer = (state: GiftCardState, reducer: GiftCardAction): GiftCardState =>
  baseReducer<GiftCardState, GiftCardAction, GiftCardActionType[]>(state, reducer, type)
