  // File-level aliases for test imports
  '#components/auth/CommerceLayer': path.resolve(__dirname, 'src/components/auth/CommerceLayer.tsx'),
  '#components/skus/AvailabilityTemplate': path.resolve(__dirname, 'src/components/skus/AvailabilityTemplate.tsx'),
