    ...
    relationships: {
      ...
      orders: {
        links: {
          ...
          related: "https://the-blue-brand-3.commercelayer.co/api/customers/MQxqWhJMgk/orders",
        },
      ...
      returns: {
        links: {
          ...
          related: "https://the-blue-brand-3.commercelayer.co/api/customers/MQxqWhJMgk/returns",
        },
      },
      sku_lists: {
        links: {
          self: "https://the-blue-brand-3.commercelayer.co/api/customers/MQxqWhJMgk/relationships/sku_lists",
          related: "https://the-blue-brand-3.commercelayer.co/api/customers/MQxqWhJMgk/sku_lists",
        },
      },
      attachments: {
        links: {
          self: "https://the-blue-brand-3.commercelayer.co/api/customers/MQxqWhJMgk/relationships/attachments",
          related: "https://the-blue-brand-3.commercelayer.co/api/customers/MQxqWhJMgk/attachments",
        },
      },
      events: {
        links: {
          self: "https://the-blue-brand-3.commercelayer.co/api/customers/MQxqWhJMgk/relationships/events",
          related: "https://the-blue-brand-3.commercelayer.co/api/customers/MQxqWhJMgk/events",
        },
      },
    },
      ...
      relationships: {
        market: {
          links: {
            ...
            related: "https://the-blue-brand-3.commercelayer.co/api/orders/NpyAhVkBBL/market",
          },
        },
        customer: {
          links: {
            self: "https://the-blue-brand-3.commercelayer.co/api/orders/NpyAhVkBBL/relationships/customer",
            related: "https://the-blue-brand-3.commercelayer.co/api/orders/NpyAhVkBBL/customer",
          },
        },
        shipping_address: {
          links: {
        ...
        line_items: {
          links: {
            ...
            related: "https://the-blue-brand-3.commercelayer.co/api/orders/NpyAhVkBBL/line_items",
          },
        },
        shipments: {
          links: {
            self: "https://the-blue-brand-3.commercelayer.co/api/orders/NpyAhVkBBL/relationships/shipments",
            related: "https://the-blue-brand-3.commercelayer.co/api/orders/NpyAhVkBBL/shipments",
          },
        },
        transactions: {
          links: {
            self: "https://the-blue-brand-3.commercelayer.co/api/orders/NpyAhVkBBL/relationships/transactions",
            related: "https://the-blue-brand-3.commercelayer.co/api/orders/NpyAhVkBBL/transactions",
          },
        },
        authorizations: {
          links: {
        ...
        captures: {
          links: {
            ...
            related: "https://the-blue-brand-3.commercelayer.co/api/orders/NpyAhVkBBL/captures",
          },
        },
        voids: {
          links: {
            self: "https://the-blue-brand-3.commercelayer.co/api/orders/NpyAhVkBBL/relationships/voids",
            related: "https://the-blue-brand-3.commercelayer.co/api/orders/NpyAhVkBBL/voids",
          },
        },
        refunds: {
          links: {
            self: "https://the-blue-brand-3.commercelayer.co/api/orders/NpyAhVkBBL/relationships/refunds",
            related: "https://the-blue-brand-3.commercelayer.co/api/orders/NpyAhVkBBL/refunds",
          },
        },
        order_subscriptions: {
          links: {
        ...
        order_copies: {
          links: {
            ...
            related: "https://the-blue-brand-3.commercelayer.co/api/orders/NpyAhVkBBL/order_copies",
          },
        },
        attachments: {
          links: {
            self: "https://the-blue-brand-3.commercelayer.co/api/orders/NpyAhVkBBL/relationships/attachments",
            related: "https://the-blue-brand-3.commercelayer.co/api/orders/NpyAhVkBBL/attachments",
          },
        },
        events: {
          links: {
            self: "https://the-blue-brand-3.commercelayer.co/api/orders/NpyAhVkBBL/relationships/events",
            related: "https://the-blue-brand-3.commercelayer.co/api/orders/NpyAhVkBBL/events",
          },
        },
      },
      meta: { mode: "test", organization_id: "enWoxFMOnp" },
